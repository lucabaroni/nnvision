...
from ..utility.measures import get_correlations, get_poisson_loss, get_MSE
...
def wandb_nnvision_trainer(
    ...
    **kwargs,
    ...
    # train over epochs
    for epoch, val_obj in wandb_early_stopping(
        model,
        stop_closure,
        interval=interval,
        patience=patience,
